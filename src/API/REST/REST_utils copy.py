...
class LBankAuthUtils(BaseLogger):
    ...
    def _sign(self, params: Dict[str, Any], ts) -> Dict[str, Any]:
        ...
        # signature = hmac.new(self.api_secret.encode(), query_string.encode("utf8"),
    ...
    async def _request(
        ...
        """
        self.log.info(
            "Sending request", method=method, endpoint=endpoint, params=params
        )
    ...
    async def get_api_Restrictions(self) -> Dict[str, Any]:
        ...
        return await self._request(
            "POST", "supplement/api_Restrictions.do", signed_params
        )
